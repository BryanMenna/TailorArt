        ...
        <section className="container my-5">
            ...
            <div className="text-center mb 5">
                ...
                <p className="text-muted">
                    Soluciones rápidas para tu guardarropa
                </p>
            </div>
                ...
                <div className="col-md-6">
                    <div className="border h-100 d-flex flex-column">
                        <div className="p-4">
                            ...
                            <p className="text-muted">Modificamos el largo de pantalones, faldas y vestidos. Trabajo limpio y duradero.</p>
                        ...
                        <div className="col-6">
                            <div className="border h-100 d-flex flex-column">
                                <div className="p-3">
                                    ...
                                    <p className="small text-muted">Diseñamos y confeccionamos según tus especificaciones exactas.</p>
